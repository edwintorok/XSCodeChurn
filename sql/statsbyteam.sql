...
select gr.team,gr.cjid as "#fixed CAs",gr.lcmcjid as "#HFXs",gr.clc as "fixed CA LOC churn", fr.sumteamloc as "LOC",round(gr.clc*100/fr.sumteamloc,2) as "% churn",round((1000.0*gr.cjid)/fr.sumteamloc,2) as "#CAs/KLoc",round((1000.0*gr.lcmcjid)/fr.sumteamloc,2) as "#HFXs/KLoc"
from  gr
