...
select gr.team,gr.cjid as "#CAs",gr.lcmcjid as "#HFXs",gr.clc as "CA LOC churn", fr.sumteamloc as "LOC",round(gr.clc*100/fr.sumteamloc,2) as "% churn",round((1000.0*gr.cjid)/fr.sumteamloc,2) as "#CAs/KLoc",round((1000.0*gr.lcmcjid)/fr.sumteamloc,2) as "#HFXs/KLoc" from  gr inner join fc fr on fr.team=gr.team
order by "#CAs" desc;
